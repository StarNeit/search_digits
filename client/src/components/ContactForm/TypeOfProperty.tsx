...
const OPTIONS = [
  {
    ...
    value: PropertyTypes.RESIDENTIAL_HOUSE,
    icon: (
      <svg
        className="w-16 h-16"
  ...
  },
  {
    ...
    value: PropertyTypes.COMMERCIAL_SHOP,
    icon: (
      <svg
        className="w-16 h-16"
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    value: PropertyTypes.OFFICE_BUILDING,
    icon: (
      <svg
        className="w-16 h-16"
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    value: PropertyTypes.INDUSTRIAL_WAREHOUSE,
    icon: (
      <svg
        className="w-16 h-16"
        xmlns="http://www.w3.org/2000/svg"
...
const TypeOfProperty = () => {
  const { setPropertyType } = useOnBoardingStore();

  const handleSelectProperty = (value: PropertyTypes) => {
    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-6 max-h-[60vh] overflow-auto">
        {OPTIONS.map((opt, index) => (
          <Card
            key={index}
            onClick={() => handleSelectProperty(opt.value)}
